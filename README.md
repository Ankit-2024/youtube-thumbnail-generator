...
!\[Demo](docs/Thumbnail\_genarator\_demo.gif)

### App Screenshots

|Home Page|Generating|Output Ready|Final Thumbnail|
|-|-|-|-|
|!\[Home](docs/Thumbnail\_genarator\_Home\_Page.png)|!\[Progress](docs/Thubnai\_genarator\_genaration\_progress.png)|!\[Output](docs/Genrated\_Downloadable\_OutPut.png)|!\[Final](docs/Final\_genrated\_thumbnail.png)|
...
The image prompt is sent to SD3.5 Large via Bedrock. The model returns a base64-encoded 1280×720 image optimised for YouTube thumbnail dimensions.
...
│
├── backend/
│   ├── lambda\_function.py   # Lambda handler + Bedrock + Pillow logic
...
│   ├── Thumbnail\_genarator\_demo.gif
│   ├── Thumbnail\_genarator\_Home\_Page.png
│   ├── Thubnai\_genarator\_genaration\_progress.png
│   ├── Genrated\_Downloadable\_OutPut.png
│   └── Final\_genrated\_thumbnail.png
│
├── .gitignore
└── README.md
```
...
# 2. Copy source files
cp backend/lambda\_function.py backend/package/
...
* Runtime: Python 3.12 / Architecture: x86\_64
* Memory: 512 MB / Timeout: 60s
* Environment variable: `THUMBNAIL\_BUCKET=your-bucket-name`
...
# Edit .env: REACT\_APP\_API\_URL=https://your-api-gateway-url/prod/generate
